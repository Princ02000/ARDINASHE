...
import { reportArdinashError } from "../lib/ardinash-error-reporting";
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  useEffect(() => {
    reportArdinashError(error, { boundary: "tanstack_root_error_component" });
  }, [error]);
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Zimbabwe's trusted partner for company registration, ZIMRA tax clearance, VAT, NSSA, PAYE and PRAZ compliance." },
      { name: "author", content: "Ardinash Consultancy" },
      { property: "og:title", content: "Ardinash Consultancy — Growing Wealth. Building Futures." },
      { property: "og:description", content: "Zimbabwe's trusted partner for company registration, ZIMRA tax clearance, VAT, NSSA, PAYE and PRAZ compliance." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Ardinash Consultancy — Growing Wealth. Building Futures." },
